...
function duplicateMultiArray(...anyArr1) {
  var newArray = []
  var combinedArray = [].concat(...anyArr1)
  console.log(combinedArray);
  console.log();
  // var newArray = combinedArray.filter(v => !newArrFilter.includes(v))
...
// console.log(combinedArray
  ...
  // var newArray = combinedArray.filter(v => combinedArray.indexOf(v, 2) === -1)
  return newArray
}
...
var noVowelArray = newArray.filter(v => !vowels.includes(v))
